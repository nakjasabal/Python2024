...
# 인덱스를 지정하여 데이터프레임으로 변환
df = pd.DataFrame(dict_data, index=['r0', 'r1', 'r2'])
print(f"{'최초 출력':-^30}")
print(df)

# 새로운 인덱스로 사용할 리스트를 선언
...
print(new_df2)
'''
NaN : Not a Number라는 뜻으로 유효한 값이 존재하지 않는 누락데이터를 의미함.
'''

# 따라서 완전히 새로운 인덱스를 부여하면 모든 데이터가 NaN으로 초기화된다. 
