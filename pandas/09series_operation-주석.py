...
# 두번째 시리즈 선언. 첫번째와 순서가 다르고 NaN을 포함하고 있음.  
...
# NaN은 연산자체가 불가능하므로, fill_value 옵션을 설정하여 0으로 대체한다. 
...
result = pd.DataFrame([addition, subtraction, multiplication, division], 
                      index=['덧셈', '뺄셈', '곱셈', '나눗셈'])
'''
덧셈과 뺄셈은 NaN이 그대로 연산되므로 결과도 NaN으로 저장됨
곱셈과 나눗셈은 0으로 대체되어 연산됨. 0으로 나눈 결과는 무한대이므로 inf[inity]로 저장됨.
'''
